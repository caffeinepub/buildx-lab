...
export class Backend implements backendInterface {
    ...
    async completeGuide(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.completeGuide(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteBuild(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllSharedBuilds(): Promise<Array<SharedBuild>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllSharedBuilds();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserBuilds(): Promise<Array<Build>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserBuilds();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserProgress(): Promise<Array<GuideProgress>> {
        if (this.processError) {
            try {
    ...
    async likeBuild(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.likeBuild(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveBuild(arg0: Build): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveBuild(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async shareBuild(arg0: SharedBuild): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.shareBuild(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
